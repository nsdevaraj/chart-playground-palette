/**
 * Generic CSV Data Mapping Utilities
 * 
 * Provides functionality to map CSV columns to template fields,
 * transform data, and validate compatibility for any template type.
 */

import { TemplateField, GenericTemplate } from '../template';
import { CSVParseResult, CSVSchema } from './parser';
import { suggestFieldMappings, validateAgainstSchema } from './schema';
import { extractTemplateFields } from '../template/registry';
